...
<div id='register'>
    <headerbar>
        ...
        <router-link :to="{name:'login'}" class="register-button" slot="register">立即登录</router-link>
            ...
            <div class="form-container">
                <div class="form-content">
                    ...
                    <form action="">
                        ...
                        <button type="button" @click="formsubmit">注册</button>
                        
                    </form>
                </div>
                <div class="extra-msg">
                    <ul>
                        <router-link tag="li" to="#">已有账号</router-link>
...
<script>
import {validPhone,validEmail} from '../../assets/js/fun'
...
methods:{
    formsubmit(){
       if(this.form.username==""||this.form.password==""){
        ...
        if(validPhone(this.form.username)||validEmail(this.form.username)){
           if(this.form.password.length<6){
             ...
             this.$axios.post('/users/register',this.form).then(res=>{
